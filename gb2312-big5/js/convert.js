...
function translateText(txt, targetEncoding) {
	...
	else if (targetEncoding === 4)  {
		return " 🇹🇼" + Traditionalized(txt) + " 🐼" + Pinyin(txt);
	}
	else {
		return txt;
	}
...
function translateBody(fobj ,targetEncoding) {
	...
	for (var i = 0; i < objs.length; ++ i) {
		...
		if (obj.nodeType == 3 && !obj['_seen']) {
			...
			newNode.data = translateText(obj.data, targetEncoding);
			// add another node with translated text
